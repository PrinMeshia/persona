...
<head>
	...
	<style>
		...
		body {
			background: url(<?= $imgpath?>/bg.png) no-repeat #fff;
		...
		button span {
			background: url(<?= $imgpath?>/arrow.png) repeat-x -8px -4px;
			height: 14px;
			width: 21px;
			display: block;
		...
		button span:hover {
			background: url(<?= $imgpath?>/arrow.png) repeat-x 32px -4px;
			height: 14px;
			width: 21px;
			display: block;
			outline: none;
		...
		@media only screen and (max-width: 480px) and (min-width: 320px) {
			...
			button span {
				background: url(<?= $imgpath?>/arrow.png) repeat-x -9px -4px;
				height: 14px;
				width: 21px;
				top: 12px;
				left: 8px;
...
<body>
	<div class="content">
		<div class="wrap">
			...
			<div class="grid">
				<p>
					<img src="<?= $imgpath?>/coming.png" title="">
				</p>
